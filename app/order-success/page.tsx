            ...
            >
              ...
              <div className="bg-gray-50 rounded-xl p-6 mb-8">
                <div className="flex items-center justify-center gap-3 mb-3">
                  ...
                  <span className="text-gray-600">Contact us directly:</span>
                </div>
                <p className="text-xl font-bold text-gray-900">+233 200 591 693</p>
              </div>

              <div className="flex flex-col gap-3">
                <Link
                  href="/shop"
                  className="w-full bg-gradient-to-r from-gray-900 to-gray-800 text-white py-3 rounded-xl font-medium hover:from-gray-800 hover:to-gray-700 transition-all duration-300 shadow-lg"
                >
                  Continue Shopping
                </Link>
                <Link
